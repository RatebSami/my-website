...
const productData = {
    web: {
      title: "Carote 450ml Ceramic-Lined Thermal Coffee Cup – Stylish Insulated Mug with Food-Grade Lid",
      price: "13.9€",
      description: "Experience warmth, style, and elegance in every sip with the Carote Ceramic-Lined Thermal Coffee Cup – a 2025 upgraded design made for women who love both fashion and functionality. As seen with celebrities, this portable coffee cup features a durable insulated build and a ceramic inner coating that preserves original flavors without odors or metal taste.",
      features: [
        "Brand: CAROTE 卡罗特",
        "Product Name: Ceramic Travel Coffee Mug", 
        "Capacity: 450ml", 
        "Net Weight: 250g",
        "Material: Premium ceramic coating & Food-grade PP sealed silicone ring ",
        "Dimensions:16x9cm",
        "Color: Creamy Milk White with Brown Lid",
      ],
      images: [
        "../Products/Lined Thermal Coffee Cup/b1.png",
        "../Products/Lined Thermal Coffee Cup/b2.png",
        "../Products/Lined Thermal Coffee Cup/b3.png", 
        "../Products/Lined Thermal Coffee Cup/b4.png", 
        "../Products/Lined Thermal Coffee Cup/b5.png", 
        "../Products/Lined Thermal Coffee Cup/b6.png",     
      ]
    },
    mobile: {
      title: "Mobile Apps",
