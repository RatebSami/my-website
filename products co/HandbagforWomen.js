...
const productData = {
    web: {
      title: "Semir Designer-Inspired Large Capacity Tote Bag  Stylish Printed Shoulder Handbag for Women",
      price: "23.9€",
      description: "Step into 2025 with fashion-forward charm and practical elegance, brought to you by Semir’s latest large-capacity tote bag for women. Featuring a playful checkerboard print with adorable cartoon-style accents, this eye-catching tote perfectly balances style and functionality. With its spacious interior, this bag is ideal for carrying all your daily must-haves — from books and tablets to cosmetics, wallets, and more. Whether it’s for shopping, commuting, or casual outings, this chic shoulder handbag adds personality to any outfit.",
      features: [
        "Brand: Semir (森马)",
        "Style: Fashionable, youthful, and casual", 
        "Color: Warm brown tones with printed checker pattern", 
        "Design: 2025 New Arrival · Exclusive Designer-Look",
        "Material: Durable and lightweight printed fabric",
        "Dimensions:42x29x15cm",
        "Strap Type: Long double shoulder straps for easy carrying",
        "Capacity: Large capacity – holds makeup, phone, iPad, notebooks, umbrella, and more",
        "Weight: Lightweight, easy to carry all day"
      ],
      images: [
        "../Products/Semir DesignerHandbag for Women/a1.png",
        "../Products/Semir DesignerHandbag for Women/a2.png",
        "../Products/Semir DesignerHandbag for Women/a3.png", 
        "../Products/Semir DesignerHandbag for Women/a4.png", 
        "../Products/Semir DesignerHandbag for Women/a5.png", 
        "../Products/Semir DesignerHandbag for Women/a6.png", 
        "../Products/Semir DesignerHandbag for Women/a7.png", 
        "../Products/Semir DesignerHandbag for Women/a8.png",
        "../Products/Semir DesignerHandbag for Women/a9.png", 
        "../Products/Semir DesignerHandbag for Women/a10.png", 
        "../Products/Semir DesignerHandbag for Women/a11.png", 
        "../Products/Semir DesignerHandbag for Women/a12.png", 
